...
`)
			...
			env := map[string]string{
				...
				"GC_BEADS_PORT":        "4406",
				"GC_BEADS_USER":        "maintenance-user",
				"GC_BEADS_PASSWORD":    "secret-password",
...
// city: projected GC_BEADS_* keys are explicitly empty and no Dolt state
...
func TestMaintenanceDoltScriptsRejectInvalidManagedPort(t *testing.T) {
	...
	if !strings.Contains(string(out), "invalid GC_BEADS_PORT") {
