...
`), 0o755); err != nil {
	...
	if got["GC_BEADS_PORT"] != "3307" {
		t.Fatalf("GC_BEADS_PORT = %q, want canonical 3307", got["GC_BEADS_PORT"])
	}
	...
	if !strings.Contains(stderr.String(), "GC_BEADS_PORT=9999 (canonical 3307)") {
