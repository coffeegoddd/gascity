...
func TestInitWizardConfigFromFlagsRejectsUnknownTemplate(t *testing.T) {
	...
	if _, _, err := initWizardConfigFromFlags(cmd, "", "", nil, template, "", hostedDoltInitOptions{}, proxiedServerInitOptions{}, false); err == nil {
...
func TestInitWizardConfigFromFlagsDefaultProviderInfersProviders(t *testing.T) {
	...
	wiz, mode, err := initWizardConfigFromFlags(cmd, "", defaultProvider, nil, "", "", hostedDoltInitOptions{}, proxiedServerInitOptions{}, false)
	if err != nil {
...
func TestInitWizardConfigFromFlagsProvidersCanonicalOrder(t *testing.T) {
	...
	wiz, _, err := initWizardConfigFromFlags(cmd, "", defaultProvider, providers, "", "", hostedDoltInitOptions{}, proxiedServerInitOptions{}, false)
	if err != nil {
		t.Fatalf("initWizardConfigFromFlags: %v", err)
	}
	if got := strings.Join(wiz.providers, ","); got != "claude,codex,gemini" {
...
func TestInitWizardConfigFromFlagsProvidersRequireDefault(t *testing.T) {
	...
	providers, _ := cmd.Flags().GetStringArray("providers")
	if _, _, err := initWizardConfigFromFlags(cmd, "", "", providers, "", "", hostedDoltInitOptions{}, proxiedServerInitOptions{}, false); err == nil {
...
func TestInitWizardConfigFromFlagsRejectsProviderListTypo(t *testing.T) {
	...
	_, _, err := initWizardConfigFromFlags(cmd, provider, "", nil, "", "", hostedDoltInitOptions{}, proxiedServerInitOptions{}, false)
	if err == nil {
...
func TestInitWizardConfigFromFlagsTemplateCustomRejectsProviders(t *testing.T) {
	...
	template, _ := cmd.Flags().GetString("template")
	defaultProvider, _ := cmd.Flags().GetString("default-provider")
	if _, _, err := initWizardConfigFromFlags(cmd, "", defaultProvider, nil, template, "", hostedDoltInitOptions{}, proxiedServerInitOptions{}, false); err == nil {
